...
int main(int argc, char *argv[])
{
   ...
   // U added by Usman
   Switch sharedVelocity
    (
        atmosphereProperties.lookupOrDefault("sharedVelocity", true)
    );
// sr added by Usman Rana
//- Shared switches
    Switch sharedstrainRate
    (
        atmosphereProperties.lookupOrDefault("strainRate", true)
    );
// tau added by Usman Rana
//- Shared switches
    Switch sharedtau
    (
        atmosphereProperties.lookupOrDefault("tau", true)
    );
...
// U added by Usman Rana
    ...
    (
        sharedstrainRate
      ? "sr"
      : IOobject::groupName("sr", phaseName)
    );
...
// tau added by Usman Rana
    ...
    (
        sharedtau
      ? "tau"
      : IOobject::groupName("tau", phaseName)
    );    
