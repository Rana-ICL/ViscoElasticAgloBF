...
// lookuporConstructtau added by Usman Rana
Foam::volSymmTensorField& Foam::basicThermoModel::lookupOrConstructtau
(
    const fvMesh& mesh,
    const char* name,
    const IOobject::readOption rOpt,
...
) const
{
        ...
        else
        {
            fPtr =
                ...
                (
                    ...
                    mesh,
                    dimensioned<symmTensor>(dims, Zero)
                );
        }
    ...
    return mesh.objectRegistry::lookupObjectRef<volSymmTensorField>(name);
}



// lookuporConstructU added by Usman Rana
Foam::volVectorField& Foam::basicThermoModel::lookupOrConstructU
(
    const fvMesh& mesh,
    const char* name,
    const IOobject::readOption rOpt,
