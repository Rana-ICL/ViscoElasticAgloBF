    ...
    basicConstructorTable::iterator cstrIter =
        ...
        (
            ...
            basicConstructorTablePtr_
             ...
             // U added by Usman Rana
    return cstrIter()(phaseName, p,U, rho, e, T, dict, master);
}
...
)
{
    ...
    if (type == "basic")
    {       // U added by Usman Rana 
        return NewBasic(phaseName, p,U, rho, e, T, dict, master);
    }
    else if (type == "detonating")
    {         // U added by Usman Rana
        return NewDetonating(phaseName, p,U, rho, e, T, dict, master);
    }
    else
    {
