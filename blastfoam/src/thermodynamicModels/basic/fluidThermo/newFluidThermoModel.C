...
(
   ...
   // sr added by Usman Rana
    volScalarField& sr,
    // stress tensor tau added by Usman Rana
    ...
    basicConstructorTable::iterator cstrIter =
        ...
        (
            ...
            basicConstructorTablePtr_
             ...
             // U,sr and tau added by Usman Rana
    return cstrIter()(phaseName, p, U, sr, tau, rho, e, T, dict, master);
}
...
)
{
    detonatingConstructorTable::iterator cstrIter =
        ...
        (
           ...
           // U, sr and tau sradded by Usman Rana
    return cstrIter()(phaseName, p, U,sr, tau, rho, e, T, dict, master);
}
...
)
{
    ...
    if (type == "basic")
    {       // U,sr and tau added by Usman Rana 
        return NewBasic(phaseName, p,U, sr, tau, rho, e, T, dict, master);
    }
    else if (type == "detonating")
    {         // U, sr and tau added by Usman Rana
        return NewDetonating(phaseName, p,U, sr, tau, rho, e, T, dict, master);
    }
    else
    {
