...
:
    ...
    mu_nod(readScalar(dict.subDict("transport").lookup("mu_nod"))),
    mu_inf(readScalar(dict.subDict("transport").lookup("mu_inf"))),
    k_(readScalar(dict.subDict("transport").lookup("k"))),    
    a_(readScalar(dict.subDict("transport").lookup("a")))  
{}
